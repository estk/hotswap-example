    ...
    pub mod hotswap {
        ...
        pub mod salutation {
            ...
            pub mod user {
                ...
                pub type Time = super::super::super::super::hotswap::salutation::user_types::Time;
                #[doc(hidden)]
                ...
                pub unsafe fn _export_age_in_weeks_cabi<T: Guest>(
                    ...
                    let len1 = arg4;
                    let result2 = T::age_in_weeks(super::super::super::super::hotswap::salutation::user_types::User{
        ...
        }, super::super::super::super::hotswap::salutation::user_types::Time{
          seconds: arg6 as u64,
          nanos: arg7 as u64,
        });
                    _rt::as_i32(result2)
